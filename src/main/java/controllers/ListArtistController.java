...
public class ListArtistController implements Initializable {
    ...
    public void artistEditingButtonClicked(MouseEvent mouseEvent) {
        if(ListArtistSelectionListener.getAuteurSelected() == null) {
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/views/artistSelectionError.fxml"));
            ...
            try {
                ...
                editArtistController.initialize(getClass().getResource("/views/editArtist.fxml"), null);
                Parent root = FXMLLoader.load(getClass().getResource("/views/editArtist.fxml"));
    ...
    public void artistDeletingButtonClicked(MouseEvent mouseEvent) {
        if(ListArtistSelectionListener.getAuteurSelected() == null) {
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/views/deleteArtistConfirmation.fxml"));
